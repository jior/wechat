...
<body>
    <div id="navigation">
        <div class="container-fluid">
            <div>
                <a href="<%=request.getContextPath()%>/mx/wechat/main" target="_self" id="brand"></a>
                <a href="<%=request.getContextPath()%>/mx/wechat/main" target="_self" class="toggle-nav" rel="tooltip" data-placement="bottom" title="Toggle navigation"><i class="icon-reorder"></i></a>
            </div>
            <ul class="main-nav">
                <li class="active">
        ...
        <div id="left" style="overflow: hidden; outline: none;" tabindex="5000">
            <div class="subnav">
                <div class="subnav-title ">
                    <a href="javascript:void(0)" class="toggle-subnav"><i class="icon-angle-right"></i><span>用户信息</span></a>
                </div>
