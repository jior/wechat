...
public interface WxMemberService {
	 ...
	 * @return
	 */
	int getWxMemberCountByQueryCriteria(WxMemberQuery query);
	 ...
	 * @return
	 */
	List<WxMember> getWxMembersByQueryCriteria(int start, int pageSize,
			WxMemberQuery query);
	 ...
	 * @return
	 */
	List<WxMember> list(WxMemberQuery query);
