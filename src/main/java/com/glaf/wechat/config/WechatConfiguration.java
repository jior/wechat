 ...
 */
public class WechatConfiguration extends Configuration {

	protected static final Log LOG = LogFactory
			.getLog(WechatConfiguration.class);
	...
	public static Configuration addCustomResources(Configuration conf) {
		conf.addResource("glaf-wechat-default.xml");
		conf.addResource("glaf-wechat-site.xml");
		return conf;
	}
