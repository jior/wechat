 ...
 */
package com.glaf.wechat.mongodb.config;
...
public class MongodbContextFactory {
	protected static final Log logger = LogFactory
			.getLog(MongodbContextFactory.class);
	private final static String DEFAULT_CONFIG = "com/glaf/wechat/mongodb/config/mongodb-context.xml";
	...
	public static ClassPathXmlApplicationContext reload() {
		...
		String configLocation = CustomProperties
				.getString("wechat.mongodb.context");
