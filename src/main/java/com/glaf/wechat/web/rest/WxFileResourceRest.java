...
public class WxFileResourceRest {
	...
	public byte[] deleteById(@Context HttpServletRequest request)
			throws IOException {
		wxFileService.deleteById(RequestUtils.getLong(request, "id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	@ResponseBody
	@Produces({ MediaType.APPLICATION_OCTET_STREAM })
	public byte[] saveWxFile(@Context HttpServletRequest request) {
		Map<String, Object> params = RequestUtils.getParameterMap(request);
		WxFile wxFile = new WxFile();
		try {
			Tools.populate(wxFile, params);
			...
			wxFile.setUuid(request.getParameter("uuid"));
			wxFile.setCreateBy(request.getParameter("createBy"));
			wxFile.setCreateDate(RequestUtils.getDate(request, "createDate"));

			this.wxFileService.save(wxFile);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		...
		if (wxFile != null) {
			...
			result.put("wxFileId", wxFile.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
