...
public class WxPortalController {
	protected final static Log logger = LogFactory
			.getLog(WxPortalController.class);
	...
	public ModelAndView home(HttpServletRequest request, ModelMap modelMap) {
		...
		try {
			...
			org.json.JSONArray array = sysApplicationService.getUserMenu(
					app.getId(), userId);
		...
		return new ModelAndView("/wx/portal/home", modelMap);
	}

	@RequestMapping("/wx/my/main")
	public ModelAndView main(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/wx/portal/main", modelMap);
	}
