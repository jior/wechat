...
public interface WxConfigService {
	 ...
	 * @return
	 */
	int getWxConfigCountByQueryCriteria(WxConfigQuery query);
	 ...
	 * @return
	 */
	List<WxConfig> getWxConfigsByQueryCriteria(int start, int pageSize,
			WxConfigQuery query);
	 ...
	 * @return
	 */
	List<WxConfig> list(WxConfigQuery query);
