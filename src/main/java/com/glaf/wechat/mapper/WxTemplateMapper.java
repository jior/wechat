...
public interface WxTemplateMapper {
	...
	void deleteWxTemplates(WxTemplateQuery query);
	...
	List<WxTemplate> getWxTemplates(WxTemplateQuery query);

	void insertWxTemplate(WxTemplate model);

	void updateWxTemplate(WxTemplate model);
