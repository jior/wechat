...
public interface WxCategoryMapper {
	...
	void deleteWxCategories(WxCategoryQuery query);
	...
	List<WxCategory> getWxCategories(WxCategoryQuery query);

	void insertWxCategory(WxCategory model);

	void updateWxCategory(WxCategory model);
