...
public interface WxConfigMapper {
	...
	void deleteWxConfigs(WxConfigQuery query);
	...
	List<WxConfig> getWxConfigs(WxConfigQuery query);

	void insertWxConfig(WxConfig model);

	void updateWxConfig(WxConfig model);
