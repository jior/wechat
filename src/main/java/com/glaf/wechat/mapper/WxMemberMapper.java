...
public interface WxMemberMapper {
	...
	void deleteWxMembers(WxMemberQuery query);
	...
	List<WxMember> getWxMembers(WxMemberQuery query);

	void insertWxMember(WxMember model);

	void updateWxMember(WxMember model);
